...
public class Prostor {
    ...
    private String popisVychodu() {
        String vracenyText = "Kam muzu jit:\t";
    ...
    /**
     * Vrací textový řetězec, který popisuje veci v místnosti, například:
     * "veci: rucnik ".
     *
     * @return Popis věcí v místnosti
     */ 
    private String popisVeci(){
        String vracenyText = "Co vidim:\t";
    ...
    public Collection<Prostor> getVychody() {
      ...
      /**
     * Vkládá věc do seznamu všech věcí. 
     * 
     *
     * @return Vkládání nové věci
     */
    public void vlozVec(Vec neco){
       ...
       /**
     * Odebírá věc ze seznamu všech věcí.Věc je vyhledávána podle názvu.
     * 
     *
    ...
    public Vec vratVec(String nazev){
      ...
      /**
     * Veřejná metoda, která vrátí popis věci v místnosti
     * 
     *
     * @return Vrací popis věcí v místnosti
     */
